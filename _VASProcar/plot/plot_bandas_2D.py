...
if (save_png == 1): plt.savefig(Diretorio_saida + 'Bandas.png', dpi = 600)
if (save_pdf == 1): plt.savefig(Diretorio_saida + 'Bandas.pdf', dpi = 600)
if (save_eps == 1): plt.savefig(Diretorio_saida + 'Bandas.eps', dpi = 600)
