...
#----------------------------------------------------------------------
#----------------------------------------------------------------------
# Copiando o codigo plot_spin.py para o diretório de saida ------------
#----------------------------------------------------------------------
#----------------------------------------------------------------------

import shutil

# Teste para saber se o arquivo plot_spin.py já se encontra no diretorio de saida
try: f = open('saida/Spin/plot_spin.py'); f.close(); os.remove('saida/Spin/plot_spin.py')
except: 0 == 0
   
source = Diretorio + '/plot_projecao_spin.py'
destination = 'saida/Spin/plot_projecao_spin.py'
shutil.copyfile(source, destination)
os.rename('saida/Spin/plot_projecao_spin.py', 'saida/Spin/plot_spin.py')

#-----------------------------------------------------------------------------------------
#-----------------------------------------------------------------------------------------
# Inserindo parâmetros para que o código plot_spin.py possa ser executado isoladamente ---
#-----------------------------------------------------------------------------------------
#-----------------------------------------------------------------------------------------

file = open('saida/Spin/plot_spin.py', 'r')
...
file = open('saida/Spin/plot_spin.py', 'w')
file.writelines(lines)
file.close()

#-------------------------------------
executavel = 'saida/Spin/plot_spin.py'
exec(open(executavel).read())
#-------------------------------------
