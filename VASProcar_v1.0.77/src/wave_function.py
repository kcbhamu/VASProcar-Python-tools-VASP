...
#------------------------------------------------------------------------
if os.path.isdir(dir_files + '/output/Funcao_Onda'):
   0 == 0
else:
   os.mkdir(dir_files + '/output/Funcao_Onda')
#---------------------------------------------

#======================================================================
# Verificando a presenca do arquivo WAVECAR ===========================
#======================================================================

try:
    f = open(dir_files + '/WAVECAR')
    f.close()
except:
    print('------------------------------------------------------------------------------------')
    print('Arquivo WAVECAR ausente no diretorio, insira o arquivo e aperte ENTER para continuar')
    print('------------------------------------------------------------------------------------')
...
for l in range(1,(3+1)):
    ...
    #--------------------------------------------------------------------------
    funcao_onda = open(dir_files + '/output/Funcao_Onda/' + name + '.agr', "w")
    #--------------------------------------------------------------------------
    ...
    if (save_png == 1): plt.savefig(dir_files + '/output/Funcao_Onda/' + name + '.png', dpi = 600)
    if (save_pdf == 1): plt.savefig(dir_files + '/output/Funcao_Onda/' + name + '.pdf', dpi = 600)
    if (save_eps == 1): plt.savefig(dir_files + '/output/Funcao_Onda/' + name + '.eps', dpi = 600)
