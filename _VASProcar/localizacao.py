...
source = Diretorio + '/plot_localizacao.py'
destination = 'saida/Localizacao/plot_localizacao.py'
shutil.copyfile(source, destination)
os.rename('saida/Localizacao/plot_localizacao.py', 'saida/Localizacao/localizacao.py')
