...
if (Dimensao == 1): bandas.write(f'@    xaxis  label "(2pi/Param.)" \n') 
if (Dimensao == 2): bandas.write(f'@    xaxis  label "(1/Angs.)" \n') 
if (Dimensao == 3): bandas.write(f'@    xaxis  label "(1/nm)" \n') 
...
plt.savefig('saida/Bandas/Bandas.png', dpi=300)
plt.savefig('saida/Bandas/Bandas.pdf', dpi=300)
# plt.savefig('saida/Bandas/Bandas.eps', dpi=300)
