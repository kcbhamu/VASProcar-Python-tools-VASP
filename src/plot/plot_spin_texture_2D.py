...
#----------------------------------------------------------------------
   ...
   if (i == 1):
      cs = ax.quiver(eixo1[::pulo], eixo2[::pulo], Spin_Sx[::pulo], nulo[::pulo], angle[::pulo], cmap = map_red_blue, norm = norma, linewidths = 0.25, edgecolor = 'black',
                     alpha = transp, width = espessura, scale = comprimento, scale_units = 'inches', pivot = 'middle', minlength = 0.0)
      
   if (i == 2):
      cs = ax.quiver(eixo1[::pulo], eixo2[::pulo], nulo[::pulo], Spin_Sy[::pulo], angle[::pulo], cmap = map_red_blue, norm = norma, linewidths = 0.25, edgecolor = 'black',
                     alpha = transp, width = espessura, scale = comprimento, scale_units = 'inches', pivot = 'middle', minlength = 0.0)
   
   if (i == 3):
      cs = ax.quiver(eixo1[::pulo], eixo2[::pulo], Spin_Sz[::pulo], nulo[::pulo], angle[::pulo], cmap = map_red_blue, norm = norma, linewidths = 0.25, edgecolor = 'black',
                     alpha = transp, width = espessura, scale = comprimento, scale_units = 'inches', pivot = 'middle', minlength = 0.0)
   ...
   if (i != 4):   
      cbar = fig.colorbar(cs, location = 'right', orientation = 'vertical', shrink = 1.0, boundaries = [0, 180, 360], ticks = [90, 270])
      cbar.ax.set_yticklabels([L1, L2])

   if (i == 4):   
      cbar = fig.colorbar(cs, location = 'right', orientation = 'vertical', shrink = 1.0, values = [45, 90, 135, 180, 225], ticks = [45, 90, 135, 180, 225])
