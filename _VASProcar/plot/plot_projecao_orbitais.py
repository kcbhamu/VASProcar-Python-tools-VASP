...
for l in range (1,(loop+1)):     # Loop para a analise das Projecoes
    ...
    if (save_png == 1): plt.savefig(Diretorio_saida + file + '_[mistura]' + '.png', dpi = 600)
    if (save_pdf == 1): plt.savefig(Diretorio_saida + file + '_[mistura]' + '.pdf', dpi = 600)
    if (save_eps == 1): plt.savefig(Diretorio_saida + file + '_[mistura]' + '.eps', dpi = 600)
...
print("= gerados na pasta saida\Orbitais ==========================")   
