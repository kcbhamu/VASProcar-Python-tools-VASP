...
#---------------------------------
exec(open("_Core/extraction.py").read())
#---------------------------------
...
#-------------------------------------------
entrada = open("_input/input_Contribuicao.txt", "r")
#-------------------------------------------
...
#----------------------------------------------------
contrib_ions = open("saida/Contribuicao_dos_ions.txt", "w")
...
#====================== Lendo o Orbital Total ==========================
               ...
               for ion_n in range (1, (ni+1)):
                   ...
                   if (lorbit >= 11):
                      ...
                      tot[ion_n] = float(VTemp[10])
                      # -----------------------------------------------------------------------------------------------------------------------------------------
                      p[ion_n] = (px[ion_n] + py[ion_n] + pz[ion_n]); d[ion_n] = (dxy[ion_n] + dyz[ion_n] + dz2[ion_n] + dxz[ion_n] + dx2[ion_n])

                   if (lorbit == 10):
                      VTemp = procar.readline().split() 
                      ion = int(VTemp[0]); s[ion_n] = float(VTemp[1]); p[ion_n] = float(VTemp[2]); d[ion_n] = float(VTemp[3]); tot[ion_n] = float(VTemp[4])           
...
#-----------------------------------------------------------------------
               ...
               for ion_n in range (1, (ni+1)):
                   if (lorbit >= 11):
                      ...
                      dxy[ion_n] = (dxy[ion_n]/orb_total)*100; dyz[ion_n] = (dyz[ion_n]/orb_total)*100; dz2[ion_n] = (dz2[ion_n]/orb_total)*100; dxz[ion_n] = (dxz[ion_n]/orb_total)*100; dx2[ion_n] = (dx2[ion_n]/orb_total)*100 
                      #-------------------------
                      ...
                      soma_dxy = soma_dxy + dxy[ion_n]; soma_dyz = soma_dyz + dyz[ion_n]; soma_dz2 = soma_dz2 + dz2[ion_n]; soma_dxz = soma_dxz + dxz[ion_n]; soma_dx2 = soma_dx2 + dx2[ion_n]
                      #-------------------------
                      if (tot[ion_n] != 0):
