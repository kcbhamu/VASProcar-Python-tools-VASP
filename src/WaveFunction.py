...
#------------------------------------------------------------------------
if os.path.isdir("output/Funcao_Onda"):
   0 == 0
else:
   os.mkdir("output/Funcao_Onda")
#--------------------------------
...
for l in range(1,(3+1)):
    ...
    #-------------------------------------------------------------
    funcao_onda = open('output/Funcao_Onda/' + name + '.agr', "w")
    #-------------------------------------------------------------
    ...
    if (save_png == 1): plt.savefig('output/Funcao_Onda/' + name + '.png', dpi = 600)
    if (save_pdf == 1): plt.savefig('output/Funcao_Onda/' + name + '.pdf', dpi = 600)
    if (save_eps == 1): plt.savefig('output/Funcao_Onda/' + name + '.eps', dpi = 600)
