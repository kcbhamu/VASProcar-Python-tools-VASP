...
if (escolha == 10  or escolha == -10):  executavel = Diretorio + '/fermi_surface.py'
if (escolha == 11  or escolha == -11):  executavel = Diretorio + '/level_countour.py'
if (escolha == 12  or escolha == -12):  executavel = Diretorio + '/bandas_3D.py'
if (escolha == 13  or escolha == -13):  executavel = Diretorio + '/bandas_4D.py'
