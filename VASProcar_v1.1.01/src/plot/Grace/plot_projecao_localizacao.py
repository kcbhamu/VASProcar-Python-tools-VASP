...
for t in range (1,(5+1)):
    ...
    if (t == 1 and num_A == 1):
       print (f'Analisando a Localizacao dos Estados (Regiao 1: {rotulo_A})')
    if (t == 2 and num_B == 1):
       print (f'Analisando a Localizacao dos Estados (Regiao 2: {rotulo_B})')
    if (t == 3 and num_C == 1):
       print (f'Analisando a Localizacao dos Estados (Regiao 3: {rotulo_C})')
    if (t == 4 and num_D == 1):
       print (f'Analisando a Localizacao dos Estados (Regiao 4: {rotulo_D})')
    if (t == 5 and num_E == 1):
       print (f'Analisando a Localizacao dos Estados (Regiao 5: {rotulo_E})') 
