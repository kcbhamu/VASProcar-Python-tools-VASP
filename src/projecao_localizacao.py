...
#----------------------------------------------------------------------------
if os.path.isdir("output/Localizacao"):
   0 == 0
else:
   os.mkdir("output/Localizacao")
#--------------------------------
...
#----------------------------------------------------------------------
contribuicao = open("output/Localizacao/Contribuicao_Regioes.txt", "w")
#----------------------------------------------------------------------
...
projection = open("output/Localizacao/Localizacao_estados.agr", "w")
...
#--------------------------------------------------
bandas = open("output/Localizacao/Bandas.dat", "w")
#--------------------------------------------------
...
#------------------------------------------------------------
Localizacao = open("output/Localizacao/Localizacao.dat", "w")
#------------------------------------------------------------
...
#--------------------------------------------------------
color_rgb = open("output/Localizacao/color_rgb.dat", "w")
#--------------------------------------------------------
...
try: f = open('output/Localizacao/Localizacao.py'); f.close(); os.remove('output/Localizacao/Localizacao.py')
except: 0 == 0
   
source = main_dir + '/plot/plot_projecao_localizacao.py'
destination = 'output/Localizacao/Localizacao.py'
...
file = open('output/Localizacao/Localizacao.py', 'r')
...
file = open('output/Localizacao/Localizacao.py', 'w')
file.writelines(lines)
file.close()

#-----------------------------------------------------
exec(open('output/Localizacao/Localizacao.py').read())
#-----------------------------------------------------
