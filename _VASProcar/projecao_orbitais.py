...
for l in range (1,(loop+1)):     # Loop para a analise das Projecoes
    ...
    if (l == 1):
       ...
       ax.scatter(rx, ry, s = D, c = 'green', alpha = 1.0, edgecolors = 'none', label = 'D')
    ...
    if (l == 2):
       ...
       ax.scatter(rx, ry, s = Pz, c = 'green', alpha = 1.0, edgecolors = 'none', label = 'Pz')
    ...
    if (l == 3):
       ...
       ax.scatter(rx, ry, s = Dz2, c = 'green',   alpha = 1.0, edgecolors = 'none', label = 'Dz2')
       ax.scatter(rx, ry, s = Dxz, c = 'brown',   alpha = 1.0, edgecolors = 'none', label = 'Dxz')
