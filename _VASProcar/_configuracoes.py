...
print ("## ======================================================== ##")
if (SO == 2):
   print ("## Projecao da Textura de Spin (Plot 2D, 3D ou 4D)          ##")
...
source = Diretorio + '/_BibTeX.dat'
destination = 'saida/BibTeX.dat'
shutil.copyfile(source, destination)

source = Diretorio + '/_DOI.png'
...
if (escolha == 62  or escolha == -62):  executavel = Diretorio + '/spin_texture.py' 
