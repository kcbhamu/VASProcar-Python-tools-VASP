...
#-------------------------------------------------------------------------------------------
# Verificando se as pastas "Bandas_3D" e "data" existem, se não existirem elas serão criadas
#-------------------------------------------------------------------------------------------
...
destination = 'saida/Bandas_3D/plot_bandas_3D_plotly.py'
shutil.copyfile(source, destination)
os.rename('saida/Bandas_3D/plot_bandas_3D_plotly.py', 'saida/Bandas_3D/bandas_3D_plotly.py')

source = Diretorio + '/plot_bandas_3D_matplotlib.py'
destination = 'saida/Bandas_3D/plot_bandas_3D_matplotlib.py'
shutil.copyfile(source, destination)
os.rename('saida/Bandas_3D/plot_bandas_3D_matplotlib.py', 'saida/Bandas_3D/bandas_3D_matplotlib.py')
