...
for l in range(1,(3+1)):
    ...
    if (save_png == 1): plt.savefig('saida/Potencial/' + name + '.png', dpi=300)
    if (save_pdf == 1): plt.savefig('saida/Potencial/' + name + '.pdf', dpi=300)
    if (save_eps == 1): plt.savefig('saida/Potencial/' + name + '.eps', dpi=300)
