...
#-----------------------------------------------------------------------------------
if os.path.isdir("saida/Level_Countour"):
   0 == 0
else:
   os.mkdir("saida/Level_Countour")
#---------------------------------- 
...
#--------------------------------------------------------------
countour = open("saida/Level_Countour/Level_Countour.dat", "w")
#--------------------------------------------------------------
...
try: f = open('saida/Level_Countour/Level_Countour.py'); f.close(); os.remove('saida/Level_Countour/Level_Countour.py')
except: 0 == 0
 
source = Diretorio + '/plot/plot_level_countour.py'
destination = 'saida/Level_Countour/Level_Countour.py'
...
file = open('saida/Level_Countour/Level_Countour.py', 'r')
...
file = open('saida/Level_Countour/Level_Countour.py', 'w')
file.writelines(lines)
file.close()

#----------------------------------------------------
executavel = 'saida/Level_Countour/Level_Countour.py'
exec(open(executavel).read())
#----------------------------------------------------
