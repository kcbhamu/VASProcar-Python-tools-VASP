...
#-----------------------------------------------------------------------
    ...
    for i in range (1,(3+1)):
        ...
        if (i == 1):
           grac='s0'; color = cor_spin[2]; legenda = 'Up'         # Cor (Vermelho) da componente Up dos Spins Sx, Sy e Sz.
        if (i == 2):
           grac='s1'; color = cor_spin[3]; legenda = 'Down'       # Cor (Azul) da componente Down dos Spins Sx, Sy e Sz.
        if (i == 3):
           grac='s2'; color = cor_spin[1]; legenda = 'Nulo'       # Cor (Preto) da componente Nula dos Spins Sx, Sy e Sz.
