...
#-----------------------------------------------------------------
# escolha = ???; n_iso = ???, n_d = ???, esc = ???, Band = ???, Band_1 = ???; Band_2 = ???; Dimensao = ???
...
if (Plot_4D == 1):
   ...
   #--------------------------------------------------------
   OLD = '# escolha = ???; n_iso = ???, n_d = ???, esc = ???, Band = ???, Band_1 = ???; Band_2 = ???; Dimensao = ???'
   NEW = 'escolha = ' + str(escolha) + '; ' 'n_iso = ' + str(n_iso) + '; ' 'n_d = ' + str(n_d) + '; ' 'esc = ' + str(esc) + '; '
   NEW = NEW + 'Band = ' + str(Band) + '; ' 'Band_1 = ' + str(Band_1) + '; ' 'Band_2 = ' + str(Band_2) + '; ' 'Dimensao = ' + str(Dimensao)
   #--------------------------------------------------------
