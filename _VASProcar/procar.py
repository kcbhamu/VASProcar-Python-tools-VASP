...
if (lorbit != 10): 
   orb = [[[[[0]*(ni+1) for i in range(nb+1)] for j in range(nk+1)] for k in range(9+1)] for l in range(n_procar+1)]  # orb[n_procar][9][nk][nb][ni]

if (lorbit == 10): 
   orb = [[[[[0]*(ni+1) for i in range(nb+1)] for j in range(nk+1)] for k in range(3+1)] for l in range(n_procar+1)]  # orb[n_procar][3][nk][nb][ni]

#  orb[n_procar][1][nk][nb][ni] = Contrinuição de cada ion para o orbital orbital S
#  orb[n_procar][2][nk][nb][ni] = Contrinuição de cada ion para o orbital orbital Py ou P (lorbit = 10)
#  orb[n_procar][3][nk][nb][ni] = Contrinuição de cada ion para o orbital orbital Pz ou D (lorbit = 10)
#  orb[n_procar][4][nk][nb][ni] = Contrinuição de cada ion para o orbital orbital Px
#  orb[n_procar][5][nk][nb][ni] = Contrinuição de cada ion para o orbital orbital Dxy
#  orb[n_procar][6][nk][nb][ni] = Contrinuição de cada ion para o orbital orbital Dyz
#  orb[n_procar][7][nk][nb][ni] = Contrinuição de cada ion para o orbital orbital Dz2
#  orb[n_procar][8][nk][nb][ni] = Contrinuição de cada ion para o orbital orbital Dxz
#  orb[n_procar][9][nk][nb][ni] = Contrinuição de cada ion para o orbital orbital Dx2

if (SO == 2):
   if (lorbit != 10): 
      Sx = [[[[[0]*(ni+1) for i in range(nb+1)] for j in range(nk+1)] for k in range(9+1)] for l in range(n_procar+1)]  # Sx[n_procar][9][nk][nb][ni]
      Sy = [[[[[0]*(ni+1) for i in range(nb+1)] for j in range(nk+1)] for k in range(9+1)] for l in range(n_procar+1)]  # Sy[n_procar][9][nk][nb][ni]
      Sz = [[[[[0]*(ni+1) for i in range(nb+1)] for j in range(nk+1)] for k in range(9+1)] for l in range(n_procar+1)]  # Sz[n_procar][9][nk][nb][ni]
   if (lorbit == 10): 
      Sx = [[[[[0]*(ni+1) for i in range(nb+1)] for j in range(nk+1)] for k in range(3+1)] for l in range(n_procar+1)]  # Sx[n_procar][3][nk][nb][ni]
      Sy = [[[[[0]*(ni+1) for i in range(nb+1)] for j in range(nk+1)] for k in range(3+1)] for l in range(n_procar+1)]  # Sy[n_procar][3][nk][nb][ni]
      Sz = [[[[[0]*(ni+1) for i in range(nb+1)] for j in range(nk+1)] for k in range(3+1)] for l in range(n_procar+1)]  # Sz[n_procar][3][nk][nb][ni]

#  Sx[n_procar][1][nk][nb][ni] = Contrinuição de cada ion para o orbital S de Sx
#  Sx[n_procar][2][nk][nb][ni] = Contrinuição de cada ion para o orbital Py ou P (lorbit = 10) de Sx
#  Sx[n_procar][3][nk][nb][ni] = Contrinuição de cada ion para o orbital Pz ou D (lorbit = 10) de Sx
#  Sx[n_procar][4][nk][nb][ni] = Contrinuição de cada ion para o orbital Px de Sx
#  Sx[n_procar][5][nk][nb][ni] = Contrinuição de cada ion para o orbital Dxy de Sx
#  Sx[n_procar][6][nk][nb][ni] = Contrinuição de cada ion para o orbital Dyz de Sx
#  Sx[n_procar][7][nk][nb][ni] = Contrinuição de cada ion para o orbital Dz2 de Sx
#  Sx[n_procar][8][nk][nb][ni] = Contrinuição de cada ion para o orbital Dxz de Sx
#  Sx[n_procar][9][nk][nb][ni] = Contrinuição de cada ion para o orbital Dx2 de Sx
