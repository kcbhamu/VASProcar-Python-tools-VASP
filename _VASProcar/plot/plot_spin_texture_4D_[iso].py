...
if (Dimensao == 1): cd = ' (2pi/a)'
if (Dimensao == 2): cd = ' (Angs.<sup>-1</sup>)'
if (Dimensao == 3): cd = ' (nm<sup>-1</sup>)'
if (Dimensao == 4): cd = ' '
...
#--------------------------------------------------------------------------------------------------------       
    ...
    fig.write_html(Diretorio_saida + 'Spin_Texture_4D_[iso]_' + rotulo + '.html')
    ...
    # fig.write_image(Diretorio_saida + 'Spin_Texture_4D_[iso]_.png')
    # fig.write_image(Diretorio_saida + 'Spin_Texture_4D_[iso]_.pdf')
    # fig.write_image(Diretorio_saida + 'Spin_Texture_4D_[iso]_.eps')
