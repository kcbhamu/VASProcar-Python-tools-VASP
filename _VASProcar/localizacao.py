...
if (leitura == 1):
   #-------------------------------------------------
   entrada = open("input/input_localizacao.txt", "r")
   #-------------------------------------------------
...
######################## Loop dos Pontos_k ############################
    ...
    temp = 1.0; number = 0
                                                                      # Observacao: No VASP k1, k2 e k3 correspondem as coordenadas diretas de cada ponto-k na ZB, 
...
#-----------------------------------------------------------------------
            ...
            temp_loc.write(f'{comp} {auto_valor} {Prop_A} {Prop_B} {Prop_C} \n')
...
localizacao.write("@with box \n")
localizacao.write("@    box on \n")
localizacao.write("@    box 0.81, 0.95, 0.88, 0.83 \n")
localizacao.write("@box def \n")
...
for i in range (1,(3+1)):
    ...
    localizacao.write("@with ellipse \n")
    localizacao.write("@    ellipse on \n")
          
    if (i == 1):
       localizacao.write("@    ellipse 0.815, 0.92, 0.835, 0.94 \n")
       color = cor_A           # Cor (Azul) para a Região A.
    if (i == 2):
       localizacao.write("@    ellipse 0.815, 0.88, 0.835, 0.9 \n")
       color = cor_B           # Cor (Vermelho) para a Região B.
    if (i == 3):
       localizacao.write("@    ellipse 0.815, 0.84, 0.835, 0.86 \n")
       color = cor_C           # Cor (Verde) para a Região C.

    localizacao.write(f'@    ellipse color {color} \n')
    localizacao.write(f'@    ellipse fill color {color} \n')
    localizacao.write("@    ellipse fill pattern 1 \n")
    localizacao.write("@ellipse def \n")
...
for i in range (1,(3+1)):
    ...
    if (i == 1):
       localizacao.write("@    string 0.8525, 0.92 \n")
       localizacao.write("@    string color 1 \n")
       localizacao.write(f'@    string def "A" \n')
                 
    if (i == 2):         
       localizacao.write("@    string 0.8525, 0.88 \n")
       localizacao.write("@    string color 1 \n")
       localizacao.write(f'@    string def "B" \n')
              
    if (i == 3):             
       localizacao.write("@    string 0.8525, 0.84 \n")
       localizacao.write("@    string color 1 \n")
       localizacao.write(f'@    string def "C" \n')
...
#-----------------------------------------------------------------------
    ...
    temp_loc = open("temp/Temp.txt", "r")

#-----------------------------------------------------------------------

    for j in range (1,(num_tot+1)):
        VTemp = temp_loc.readline().split()
