...
for l in range(1,(3+1)):
    ...
    #----------------------------------------------------------------------
    densidade = open('saida/Densidade_Carga_Parcial/' + name + '.agr', "w")
    #----------------------------------------------------------------------
    ...
    if (save_png == 1): plt.savefig('saida/Densidade_Carga_Parcial/' + name + '.png', dpi = 600)
    if (save_pdf == 1): plt.savefig('saida/Densidade_Carga_Parcial/' + name + '.pdf', dpi = 600)
    if (save_eps == 1): plt.savefig('saida/Densidade_Carga_Parcial/' + name + '.eps', dpi = 600)
