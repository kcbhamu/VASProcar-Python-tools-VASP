...
#---------------------------------------------
bandas = open("output/Bandas/Bandas.agr", "w")
#---------------------------------------------
...
#--------------------------------------------
bandas = open("output/Bandas/Bandas.dat", "w")
#--------------------------------------------
...
try: f = open('output/Bandas/Bandas.py'); f.close(); os.remove('output/Bandas/Bandas.py')
except: 0 == 0
  
source = main_dir + '/plot/plot_bandas_2D.py'
destination = 'output/Bandas/Bandas.py'
...
file = open('output/Bandas/Bandas.py', 'r')
...
file = open('output/Bandas/Bandas.py', 'w')
file.writelines(lines)
file.close()

#-------------------------------------------
exec(open('output/Bandas/Bandas.py').read())
#-------------------------------------------
