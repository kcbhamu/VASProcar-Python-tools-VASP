...
#--------------------------------------------------------------------
if os.path.isdir("output/Plot_4D"):
   0 == 0
else:
   os.mkdir("output/Plot_4D")
#----------------------------
...
#-----------------------------------------------
plot4D = open("output/Plot_4D/Plot_4d.dat", "w")
#-----------------------------------------------
...
try: f = open('output/Plot_4D/Plot_4D.py'); f.close(); os.remove('output/Plot_4D/Plot_4D.py')
except: 0 == 0
  
source = main_dir + '/plot/plot_bandas_4D_plotly.py'
destination = 'output/Plot_4D/Plot_4D.py'
...
file = open('output/Plot_4D/Plot_4D.py', 'r')
...
file = open('output/Plot_4D/Plot_4D.py', 'w')
file.writelines(lines)
file.close()

#---------------------------------------------
exec(open('output/Plot_4D/Plot_4D.py').read())
#---------------------------------------------
