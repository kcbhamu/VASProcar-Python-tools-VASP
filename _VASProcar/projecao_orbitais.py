...
for l in range (1,(loop+1)):     # Loop para a analise das Projecoes
    ...
    if (l == 2):
       ax.scatter(rx, ry, s = Px, c = 'blue', alpha = 1.0, edgecolors = 'none', label = r'${P}_{x}$')
       ax.scatter(rx, ry, s = Py, c = 'red', alpha = 1.0, edgecolors = 'none', label = r'${P}_{y}$')
       ax.scatter(rx, ry, s = Pz, c = 'limegreen', alpha = 1.0, edgecolors = 'none', label = r'${P}_{z}$')

    if (l == 3):
       ax.scatter(rx, ry, s = Dxy, c = 'blue', alpha = 1.0, edgecolors = 'none', label = r'${D}_{xy}$')
       ax.scatter(rx, ry, s = Dyz, c = 'red', alpha = 1.0, edgecolors = 'none', label = r'${D}_{yz}$')
       ax.scatter(rx, ry, s = Dz2, c = 'limegreen', alpha = 1.0, edgecolors = 'none', label = r'${D}_{z^{2}}$')
       ax.scatter(rx, ry, s = Dxz, c = 'rosybrown', alpha = 1.0, edgecolors = 'none', label = r'${D}_{xz}$')
       ax.scatter(rx, ry, s = Dx2, c = 'magenta', alpha = 1.0, edgecolors = 'none', label = r'${D}_{x^{2}}$')
