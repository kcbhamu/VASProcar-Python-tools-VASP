...
#-----------------------------------------------------------------------
    ...
    if (i == 1):
       #-----------------------------------------------------------------
       if (esc == 0): dos_pdos = open("saida/DOS/DOS_pDOS.agr", "w")
       if (esc == 1): dos_pdos = open("saida/DOS/DOS_pDOS_lDOs.agr", "w")
       #-----------------------------------------------------------------
       print ("=================================") 
    ...
    if (i == 2):
       #---------------------------------------------------------------
       if (esc == 0): dos_pdos = open("saida/DOS/pDOS_P.agr", "w")
       if (esc == 1): dos_pdos = open("saida/DOS/pDOS_lDOS_P.agr", "w") 
       #---------------------------------------------------------------
    ...
    if (i == 3):
       #---------------------------------------------------------------
       if (esc == 0): dos_pdos = open("saida/DOS/pDOS_D.agr", "w")
       if (esc == 1): dos_pdos = open("saida/DOS/pDOS_lDOS_D.agr", "w")
       #---------------------------------------------------------------
...
#-------------------------------------------------------
dos_pdos_ldos = open("saida/DOS/dos_pdos_ldos.dat", "w")
#-------------------------------------------------------
...
#----------------------------------------------------------------------
#----------------------------------------------------------------------
# Copiando o codigo plot_dos.py para o diretório de saida -------------
#----------------------------------------------------------------------
#----------------------------------------------------------------------

import shutil

# Teste para saber se o arquivo plot_dos.py já se encontra no diretorio de saida
try: f = open('saida/DOS/plot_dos.py'); f.close(); os.remove('saida/DOS/plot_dos.py')
except: 0 == 0
   
source = Diretorio + '/plot_dos.py'
destination = 'saida/DOS/plot_dos.py'
shutil.copyfile(source, destination)
# os.rename('saida/DOS/plot_dos.py', 'saida/DOS/plot_dos_2.py')

#----------------------------------------------------------------------------------------
#----------------------------------------------------------------------------------------
# Inserindo parâmetros para que o código plot_dos.py possa ser executado isoladamente ---
#----------------------------------------------------------------------------------------
#----------------------------------------------------------------------------------------

file = open('saida/DOS/plot_dos.py', 'r')
...
file = open('saida/DOS/plot_dos.py', 'w')
file.writelines(lines)
file.close()

#----------------------------------------------
executavel = 'saida/DOS/plot_dos.py'
exec(open(executavel).read())
#----------------------------------------------
