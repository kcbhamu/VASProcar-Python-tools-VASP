...
print ("[3] Plot 4D (Sx_Sy_Sz_Vetores) na ZB ======================== ")
print ("[4] Plot 4D (Sx_Sy_Sz_isosuperficies) na ZB ================= ")
print ("##############################################################") 
...
if (escolha_d != 4): linha += 1; lines.insert(linha, f'nk = {nk} \n')
linha += 1; lines.insert(linha, '\n')
linha += 1; lines.insert(linha, '#===================================================================== \n')
...
if (escolha_d == 4): executavel = 'saida/Spin_Texture/Spin_Texture_4D_[iso].py'
exec(open(executavel).read())
#------------------------------------------------------------------------------
