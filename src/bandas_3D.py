...
#-----------------------------------------------------------------------------
if os.path.isdir("output/Bandas_3D"):
   0 == 0
else:
   os.mkdir("output/Bandas_3D")
#----------------------------- 
...
#------------------------------------------------------
bandas_3D = open("output/Bandas_3D/Bandas_3D.dat", "w")
#------------------------------------------------------
...
try: f = open('output/Bandas_3D/Bandas_3D_plotly.py'); f.close(); os.remove('output/Bandas_3D/Bandas_3D_plotly.py')
except: 0 == 0

# Teste para saber se o arquivo Bandas_3D_matplotlib.py já se encontra no diretorio de saida
try: f = open('output/Bandas_3D/Bandas_3D_matplotlib.py'); f.close(); os.remove('output/Bandas_3D/Bandas_3D_matplotlib.py')
except: 0 == 0
   
source = main_dir + '/plot/plot_bandas_3D_plotly.py'
destination = 'output/Bandas_3D/Bandas_3D_plotly.py'
shutil.copyfile(source, destination)

source = main_dir + '/plot/plot_bandas_3D_matplotlib.py'
destination = 'output/Bandas_3D/Bandas_3D_matplotlib.py'
shutil.copyfile(source, destination)
...
for i in range (2):
    ...
    if (i == 0): file = open('output/Bandas_3D/Bandas_3D_plotly.py', 'r')
    if (i == 1): file = open('output/Bandas_3D/Bandas_3D_matplotlib.py', 'r')
    ...
    if (i == 0): file = open('output/Bandas_3D/Bandas_3D_plotly.py', 'w')
    if (i == 1): file = open('output/Bandas_3D/Bandas_3D_matplotlib.py', 'w')
    file.writelines(lines)
    file.close()

#---------------------------------------------------------------
if (pacote == 1):
   exec(open('output/Bandas_3D/Bandas_3D_plotly.py').read())
if (pacote == 2):
   exec(open('output/Bandas_3D/Bandas_3D_matplotlib.py').read())
#---------------------------------------------------------------
