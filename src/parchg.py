...
#------------------------------------------------------------------------------------
if os.path.isdir("output/Densidade_Carga_Parcial"):
   0 == 0
else:
   os.mkdir("output/Densidade_Carga_Parcial")
#--------------------------------------------
...
for l in range(1,(3+1)):
    ...
    #-----------------------------------------------------------------------
    densidade = open('output/Densidade_Carga_Parcial/' + name + '.agr', "w")
    #-----------------------------------------------------------------------
    ...
    if (save_png == 1): plt.savefig('output/Densidade_Carga_Parcial/' + name + '.png', dpi = 600)
    if (save_pdf == 1): plt.savefig('output/Densidade_Carga_Parcial/' + name + '.pdf', dpi = 600)
    if (save_eps == 1): plt.savefig('output/Densidade_Carga_Parcial/' + name + '.eps', dpi = 600)
