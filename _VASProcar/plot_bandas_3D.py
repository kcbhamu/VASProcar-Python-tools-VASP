...
###########################################################################
#### Para rodar este código manualmente, preencha as variaveis abaixo: ####
###########################################################################

# Band_i = ???  # Banda inicial a ser plotada.                           
# Band_f = ???  # Banda final a ser plotada.                             
# nk = ???      # Nº de pontos-k presentes no arquivo PROCAR.            
...
source = r'_VASProcar\saida_bandas_3D.py'
destination = r'saida\Bandas_3D.py'
