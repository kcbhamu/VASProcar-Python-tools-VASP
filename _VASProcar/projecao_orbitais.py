...
#  soma_orb[n_procar][1][nk][nb] = Soma da contrinuição de cada ion (selecionado) para o orbital S
#  soma_orb[n_procar][2][nk][nb] = Soma da contrinuição de cada ion (selecionado) para o orbital Py ou P (lorbit = 10)
#  soma_orb[n_procar][3][nk][nb] = Soma da contrinuição de cada ion (selecionado) para o orbital Pz ou D (lorbit = 10)
#  soma_orb[n_procar][4][nk][nb] = Soma da contrinuição de cada ion (selecionado) para o orbital Px
#  soma_orb[n_procar][5][nk][nb] = Soma da contrinuição de cada ion (selecionado) para o orbital Dxy
#  soma_orb[n_procar][6][nk][nb] = Soma da contrinuição de cada ion (selecionado) para o orbital Dyz
#  soma_orb[n_procar][7][nk][nb] = Soma da contrinuição de cada ion (selecionado) para o orbital Dz2
#  soma_orb[n_procar][8][nk][nb] = Soma da contrinuição de cada ion (selecionado) para o orbital Dxz
#  soma_orb[n_procar][9][nk][nb] = Soma da contrinuição de cada ion (selecionado) para o orbital Dx2
#  tot = Soma de cada orbital (para todos os ions)
