...
transp = 1.0  #  Neste plot a transparencia não é necessaria, modifique caso queira suavizar as cores do plot
...
if (save_png == 1): plt.savefig(Diretorio_saida + 'Localizacao_estados_[mistura].png', dpi = 600)
if (save_pdf == 1): plt.savefig(Diretorio_saida + 'Localizacao_estados_[mistura].pdf', dpi = 600)
if (save_eps == 1): plt.savefig(Diretorio_saida + 'Localizacao_estados_[mistura].eps', dpi = 600)
