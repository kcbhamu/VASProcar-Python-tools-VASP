...
try: f = open('saida/DOS/DOS_pDOS_lDOS.py'); f.close(); os.remove('saida/DOS/DOS_pDOS_lDOS.py')
except: 0 == 0
   
source = Diretorio + '/plot/plot_dos_pdos_ldos.py'
destination = 'saida/DOS/DOS_pDOS_lDOS.py'
...
file = open('saida/DOS/DOS_pDOS_lDOS.py', 'r')
...
file = open('saida/DOS/DOS_pDOS_lDOS.py', 'w')
file.writelines(lines)
file.close()

#----------------------------------------
executavel = 'saida/DOS/DOS_pDOS_lDOS.py'
exec(open(executavel).read())
#----------------------------------------
