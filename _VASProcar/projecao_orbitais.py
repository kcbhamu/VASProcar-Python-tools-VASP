...
# Obtendo e gravando as cores no padrão RGB que designam cada orbital bem como cada combinação de orbitais informação de cada orbital para o Plot das Projeções ===:

#----------------------------------------------------
color_rgb = open("saida/Orbitais/color_rgb.dat", "w")
#----------------------------------------------------
...
for Band_n in range (1, (nb+1)):
    for wp in range (1, (n_procar+1)):
        for point_k in range (1, (nk+1)):       
           ...
           #-----------------------------------------------------------------------------------------------------------------------------------------             
           # Notação do Matplotlib para o padrão RGB de cores: 
           ...
           # color_SPD[number] = [c_red, c_green, c_blue]
           #-------------------------------------------
           ...
           if (lorbit >= 11):
              ...
              color_rgb.write(f' {c_red} {c_green} {c_blue}')
              # color_P[number] = [c_red, c_green, c_blue]
           #-----------------------------------------
           
           #---------------------------------------------------------------------------------------
           # orb_Dxy = blue; orb_Dyz = red; orb_Dz2 = green; orb_Dx2 = magneta; orb_Dxz = rosybrown
           #---------------------------------------------------------------------------------------
           ...
           if (lorbit >= 11):
              ...
              color_rgb.write(f' {c_red} {c_green} {c_blue}')            
              # color_D[number] = [c_red, c_green, c_blue]
           #--------------------------------------------------------------------------------------------------------------------------------------
...
source = Diretorio + '/plot/plot_projecao_orbitais.py'
destination = 'saida/Orbitais/Orbitais.py'
