...
if (dest_k == 2 and n_procar == 1):
   ...
   # ----------------------------------------------------------------------
   # Verificando a presença do arquivo KPOINTS:: --------------------------
   # ----------------------------------------------------------------------
   ...
   print (" ")
   print ("##############################################################")
   print ("Atencao: Edite o arquivo KPOINTS, inserindo o rotulo desejado ")
   print ("         apos as coordenadas de todos os pontos-k do arquivo  ")
   print ("==============================================================")
   print ("Exemplo:                                                      ")
   ...
   print ("                      0.5 0.0 0.0 X                           ")
   print ("==============================================================")
   print ("Consulte no arquivo label.txt os codigos para a utilizacao de ")
   print ("                                              simbolos Gregos ")
   print ("==============================================================")
