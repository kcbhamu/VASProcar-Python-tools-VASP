...
#-----------------------------------------------------------------
# tipo_plot: [0] Plotado em pontos; [1] Plotado em superficie; [2] pontos + superficie
# n_d: Dimensao-D (DxD) do GRID de interpolacao
# tipo_plot = ???; n_d = ???; Band_i = ???; Band_f = ???; Plano_k = ???; Dimensao = ???
...
print(" ")
print("=========================================================")
print("= Observacao: Caso a pagina no navegador de internet === ")
print("= fique em loading infinito ou apresente alguma mensagem ")   
print("= de erro, aperter F5 para recarregar a pagina. =========")
print("=========================================================")
...
if (pasta == 0):
   ...
   #---------------------------------------------------------------
   #---------------------------------------------------------------
   # Gerando o arquivo bandas_3D_plotly.py no diretório de saida --
   #---------------------------------------------------------------
   #---------------------------------------------------------------

   try: f = open(Diretorio_saida + 'plot_bandas_3D_plotly.py'); f.close(); os.remove(Diretorio_saida + 'plot_bandas_3D_plotly.py')
   except: 0 == 0

   try: f = open(Diretorio_saida + 'bandas_3D_plotly.py'); f.close(); os.remove(Diretorio_saida + 'bandas_3D_plotly.py')
   except: 0 == 0

   source = Diretorio + '\plot_bandas_3D_plotly.py'
   destination = Diretorio_saida + 'plot_bandas_3D_plotly.py'
   ...
   #------------------------------------------------------------------------------------
   OLD = '# tipo_plot = ???; n_d = ???; Band_i = ???; Band_f = ???; Plano_k = ???; Dimensao = ???'        
   NEW = 'tipo_plot = ' + str(tipo_plot) + '; ' 'n_d = ' + str(n_d) + '; ' 'Band_i = ' + str(Band_i) + '; '
   ...
   #-------------------------------------------------------------------
   #-------------------------------------------------------------------
   # Gerando o arquivo bandas_3D_matplotlib.py no diretório de saida --
   #-------------------------------------------------------------------
   #-------------------------------------------------------------------
   
   try: f = open(Diretorio_saida + 'plot_bandas_3D_matplotlib.py'); f.close(); os.remove(Diretorio_saida + 'plot_bandas_3D_matplotlib.py')
   except: 0 == 0

   try: f = open(Diretorio_saida + 'bandas_3D_matplotlib.py'); f.close(); os.remove(Diretorio_saida + 'bandas_3D_matplotlib.py')
   except: 0 == 0

   source = Diretorio + '\plot_bandas_3D_matplotlib.py'
   destination = Diretorio_saida + 'plot_bandas_3D_matplotlib.py'
   shutil.copyfile(source, destination)
   ...
   codigo_new = open(Diretorio_saida + 'temp.py', "w")
   #------------------------------------------------------------------------------------
   OLD = '# tipo_plot = ???; Band_i = ???; Band_f = ???; Plano_k = ???; Dimensao = ???'
   NEW = 'tipo_plot = ' + str(tipo_plot) + '; ' 'Band_i = ' + str(Band_i) + '; ' 'Band_f = ' + str(Band_f) + '; ' 
   ...
   print("= bandas_3D_plotly.py e bandas_3D_matplotlib.py =========")
   print("=========================================================")
