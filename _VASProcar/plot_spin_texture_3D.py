...
plt.savefig('saida/Spin_Texture/Spin_Texture.png', dpi=300, pad_inches = 0)
plt.savefig('saida/Spin_Texture/Spin_Texture.pdf', dpi=300, pad_inches = 0)
# plt.savefig('saida/Spin_Texture/Spin_Texture.eps', dpi=300, pad_inches = 0)
