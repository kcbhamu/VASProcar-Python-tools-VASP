...
#  soma_orb[n_procar][1][nk][nb] = Soma Orbital S
#  soma_orb[n_procar][2][nk][nb] = Soma Orbital Py ou P (lorbit = 10)
#  soma_orb[n_procar][3][nk][nb] = Soma Orbital Pz ou D (lorbit = 10)
#  soma_orb[n_procar][4][nk][nb] = Soma Orbital Px
#  soma_orb[n_procar][5][nk][nb] = Soma Orbital Dxy
#  soma_orb[n_procar][6][nk][nb] = Soma Orbital Dyz
#  soma_orb[n_procar][7][nk][nb] = Soma Orbital Dz2
#  soma_orb[n_procar][8][nk][nb] = Soma Orbital Dxz
#  soma_orb[n_procar][9][nk][nb] = Soma Orbital Dx2
