...
print ("##############################################################")
print ("################# Plot da Densidade de Carga #################")
print ("##############################################################")
print (" ")
...
#--------------------------------------------------------------------------------------
# Parametro de teste para estimar se existe periodicidade ou não em determinada direção
#--------------------------------------------------------------------------------------
...
fator_x = -1000.0; fator_y = -1000.0; fator_z = -1000.0

if (A1x > fator_x): fator_x = A1x
if (A2x > fator_x): fator_x = A2x
if (A3x > fator_x): fator_x = A3x

if (A1y > fator_y): fator_y = A1y
if (A2y > fator_y): fator_y = A2y
if (A3y > fator_y): fator_y = A3y

if (A1z > fator_z): fator_z = A1z
if (A2z > fator_z): fator_z = A2z
if (A3z > fator_z): fator_z = A3z

fator_x = fator_x*Parametro
fator_y = fator_y*Parametro
fator_z = fator_z*Parametro
...
for l in range(1,(3+1)):
    ...
    if (l == 1):      
       ...
       name = 'Potencial_x'; eixo = 'X '; t_grid = Grid_x
    ...
    if (l == 2):
       ...
       name = 'Potencial_y'; eixo = 'Y '; t_grid = Grid_y
    ...
    if (l == 3):
       ...
       name = 'Potencial_z'; eixo = 'Z '; t_grid = Grid_z
