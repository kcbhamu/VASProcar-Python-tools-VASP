...
destination = 'saida/Plot_4D/plot_bandas_4D_plotly.py'
shutil.copyfile(source, destination)
os.rename('saida/Plot_4D/plot_bandas_4D_plotly.py', 'saida/Plot_4D/plot_4D.py')

#------------------------------------------------------------------------------------
#------------------------------------------------------------------------------------
# Inserindo parâmetros para que o código de Plot possa ser executado isoladamente ---
#------------------------------------------------------------------------------------
#------------------------------------------------------------------------------------
