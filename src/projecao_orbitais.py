...
#---------------------------------------------------------------------
if os.path.isdir("output/Orbitais"):
   0 == 0
else:
   os.mkdir("output/Orbitais")
#-----------------------------
...
#-----------------------------------------------------------------------
    ...
    if (i == 1):
       #----------------------------------------------------------
       projection = open("output/Orbitais/Orbitais_S_P_D.agr", "w")
       #----------------------------------------------------------
    ...
    if (i == 2):
       #------------------------------------------------------
       projection = open("output/Orbitais/Orbitais_P.agr", "w")     
       #------------------------------------------------------
    ...
    if (i == 3):
       #------------------------------------------------------
       projection = open("output/Orbitais/Orbitais_D.agr", "w")
       #------------------------------------------------------
...
#-----------------------------------------------
bandas = open("output/Orbitais/Bandas.dat", "w")
#-----------------------------------------------
...
#--------------------------------------------------
orbital = open("output/Orbitais/Orbitais.dat", "w")
#--------------------------------------------------
...
#-----------------------------------------------------
color_rgb = open("output/Orbitais/color_rgb.dat", "w")
#-----------------------------------------------------
...
try: f = open('output/Orbitais/Orbitais.py'); f.close(); os.remove('output/Orbitais/Orbitais.py')
except: 0 == 0
   
source = main_dir + '/plot/plot_projecao_orbitais.py'
destination = 'output/Orbitais/Orbitais.py'
...
file = open('output/Orbitais/Orbitais.py', 'r')
...
file = open('output/Orbitais/Orbitais.py', 'w')
file.writelines(lines)
file.close()

#-----------------------------------------------
exec(open('output/Orbitais/Orbitais.py').read())
#-----------------------------------------------
