...
for l in range (1,(loop+1)):     # Loop para a analise das Projecoes
    ...
    if (save_png == 1): plt.savefig(Diretorio_saida + file + '_[sum_colors]' + '.png', dpi = 600)
    if (save_pdf == 1): plt.savefig(Diretorio_saida + file + '_[sum_colors]' + '.pdf', dpi = 600)
    if (save_eps == 1): plt.savefig(Diretorio_saida + file + '_[sum_colors]' + '.eps', dpi = 600)
