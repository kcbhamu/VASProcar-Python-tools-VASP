...
Energia = [[[0]*((nb*ispin)+1) for i in range(nk+1)] for j in range(n_procar+1)]  # Energia[n_procar][nk][nb*ispin]
...
if (read_orb == 1):
   ...
   if (lorbit >= 11): 
      orb = [[[[[0]*(ni+1) for i in range((nb*ispin)+1)] for j in range(nk+1)] for k in range(9+1)] for l in range(n_procar+1)]  
   if (lorbit == 10): 
      orb = [[[[[0]*(ni+1) for i in range((nb*ispin)+1)] for j in range(nk+1)] for k in range(3+1)] for l in range(n_procar+1)]  

   #  orb[n_procar][1][nk][nb*ispin][ni] = Contribuição de cada ion "ni" para o orbital S em uma dada banda e ponto-k.
   #  orb[n_procar][2][nk][nb*ispin][ni] = Contribuição de cada ion "ni" para o orbital Py ou P (lorbit = 10) em uma dada banda e ponto-k.
   #  orb[n_procar][3][nk][nb*ispin][ni] = Contribuição de cada ion "ni" para o orbital Pz ou D (lorbit = 10) em uma dada banda e ponto-k.
   #  orb[n_procar][4][nk][nb*ispin][ni] = Contribuição de cada ion "ni" para o orbital Px em uma dada banda e ponto-k.
   #  orb[n_procar][5][nk][nb*ispin][ni] = Contribuição de cada ion "ni" para o orbital Dxy em uma dada banda e ponto-k.
   #  orb[n_procar][6][nk][nb*ispin][ni] = Contribuição de cada ion "ni" para o orbital Dyz em uma dada banda e ponto-k.
   #  orb[n_procar][7][nk][nb*ispin][ni] = Contribuição de cada ion "ni" para o orbital Dz2 em uma dada banda e ponto-k.
   #  orb[n_procar][8][nk][nb*ispin][ni] = Contribuição de cada ion "ni" para o orbital Dxz em uma dada banda e ponto-k.
   #  orb[n_procar][9][nk][nb*ispin][ni] = Contribuição de cada ion "ni" para o orbital Dx2 em uma dada banda e ponto-k.

   tot = [[[[0]*(ni+1) for i in range((nb*ispin)+1)] for i in range(nk+1)] for j in range(n_procar+1)]
   # tot[n_procar][nk][nb*ispin][ni] = Soma de todos os orbitais (S,P,D) para um dado ion. 
...
if (read_spin == 1):
   ...
   if (SO == 2):
      if (lorbit != 10): 
         Sx = [[[[[0]*(ni+1) for i in range((nb*ispin)+1)] for j in range(nk+1)] for k in range(9+1)] for l in range(n_procar+1)]  
         Sy = [[[[[0]*(ni+1) for i in range((nb*ispin)+1)] for j in range(nk+1)] for k in range(9+1)] for l in range(n_procar+1)]  
         Sz = [[[[[0]*(ni+1) for i in range((nb*ispin)+1)] for j in range(nk+1)] for k in range(9+1)] for l in range(n_procar+1)]  
      if (lorbit == 10): 
         Sx = [[[[[0]*(ni+1) for i in range((nb*ispin)+1)] for j in range(nk+1)] for k in range(3+1)] for l in range(n_procar+1)]  
         Sy = [[[[[0]*(ni+1) for i in range((nb*ispin)+1)] for j in range(nk+1)] for k in range(3+1)] for l in range(n_procar+1)]  
         Sz = [[[[[0]*(ni+1) for i in range((nb*ispin)+1)] for j in range(nk+1)] for k in range(3+1)] for l in range(n_procar+1)]  

   #  Sx[n_procar][1][nk][nb*ispin][ni] = Contrinuição de cada ion "ni" para o orbital S de Sx em uma dada banda e ponto-k.
   #  Sx[n_procar][2][nk][nb*ispin][ni] = Contrinuição de cada ion "ni" para o orbital Py ou P (lorbit = 10) de Sx em uma dada banda e ponto-k.
   #  Sx[n_procar][3][nk][nb*ispin][ni] = Contrinuição de cada ion "ni" para o orbital Pz ou D (lorbit = 10) de Sx em uma dada banda e ponto-k.
   #  Sx[n_procar][4][nk][nb*ispin][ni] = Contrinuição de cada ion "ni" para o orbital Px de Sx em uma dada banda e ponto-k.
   #  Sx[n_procar][5][nk][nb*ispin][ni] = Contrinuição de cada ion "ni" para o orbital Dxy de Sx em uma dada banda e ponto-k.
   #  Sx[n_procar][6][nk][nb*ispin][ni] = Contrinuição de cada ion "ni" para o orbital Dyz de Sx em uma dada banda e ponto-k.
   #  Sx[n_procar][7][nk][nb*ispin][ni] = Contrinuição de cada ion "ni" para o orbital Dz2 de Sx em uma dada banda e ponto-k.
   #  Sx[n_procar][8][nk][nb*ispin][ni] = Contrinuição de cada ion "ni" para o orbital Dxz de Sx em uma dada banda e ponto-k.
   #  Sx[n_procar][9][nk][nb*ispin][ni] = Contrinuição de cada ion "ni" para o orbital Dx2 de Sx em uma dada banda e ponto-k.
