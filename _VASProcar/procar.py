...
if (SO == 2):
   Sx = [[[[0]*(ni+1) for i in range(nb+1)] for j in range(nk+1)] for k in range(n_procar+1)]  # Sx[n_procar][nk][nb][ni]
   Sy = [[[[0]*(ni+1) for i in range(nb+1)] for j in range(nk+1)] for k in range(n_procar+1)]  # Sy[n_procar][nk][nb][ni]
   Sz = [[[[0]*(ni+1) for i in range(nb+1)] for j in range(nk+1)] for k in range(n_procar+1)]  # Sz[n_procar][nk][nb][ni]
...
#----------------------------------------------------------------------
                   ...
                   if (lorbit >= 11):
                      VTemp = procar.readline().split()
                      for i in range(1,(9+1)):
                          Sx[wp][point_k][Band_n][ion_n] = float(VTemp[i])                                                   
...
#----------------------------------------------------------------------
                   ...
                   if (lorbit >= 11):
                      VTemp = procar.readline().split()
                      for i in range(1,(9+1)):
                          Sy[wp][point_k][Band_n][ion_n] = float(VTemp[i])                                                 
...
#----------------------------------------------------------------------
                   ...
                   if (lorbit >= 11):
                      VTemp = procar.readline().split()
                      for i in range(1,(9+1)):
                          Sz[wp][point_k][Band_n][ion_n] = float(VTemp[i])                                                  
