...
for i in range(n_energ):
    ...
    if (save_png == 1): plt.savefig(dir_output + 'SFermi_' + number + '_[' + c_energ + '].png', dpi = 600, pad_inches = 0)
    if (save_pdf == 1): plt.savefig(dir_output + 'SFermi_' + number + '_[' + c_energ + '].pdf', dpi = 600, pad_inches = 0)
    if (save_eps == 1): plt.savefig(dir_output + 'SFermi_' + number + '_[' + c_energ + '].eps', dpi = 600, pad_inches = 0)
...
#=========================================================================
# Criando um video com as imagens geradas: ===============================
#=========================================================================

if (video == 1 and save_png == 1):
    
   import moviepy.video.io.ImageSequenceClip

   if (dir_output != ''):
      image_output = dir_output
   if (dir_output == ''):
      image_output = os.getcwd()
