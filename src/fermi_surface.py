...
linha += 1; lines.insert(linha, f'n_energ = {n_energ}  #  Quantidade de diferentes valores de energia a serem utilizados no plot da Superficie de Fermi \n')
linha += 1; lines.insert(linha, f'E = {E}  #  Valores de energia a serem utilizados no plot da Superficie de Fermi \n')
