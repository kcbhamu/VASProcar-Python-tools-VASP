...
if (save_png == 1): plt.savefig(Diretorio_saida + 'Bandas.png', dpi=300)
if (save_pdf == 1): plt.savefig(Diretorio_saida + 'Bandas.pdf', dpi=300)
if (save_eps == 1): plt.savefig(Diretorio_saida + 'Bandas.eps', dpi=300)
...
print("= gerados na pasta saida\Bandas =========================")   
