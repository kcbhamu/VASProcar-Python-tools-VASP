print (" ")
print ("##############################################################################################")
print ("## VASProcar v1.0.2 (21/01/2022) - https://github.com/Augusto-Dlelis/VASProcar-Tools-Python ##")
print ("## Autores: ##################################################################################")
print ("## ======================================================================================== ##")
...
print ("## ======================================================================================== ##")
print ("## Renan da Paixão Maciel - Uppsala University (Uppsala/Sweden) ##############################")
...
# [2] Estimar o valor correto do parâmetro, como sendo o menor valor entre
#     o modulo dos vetores A1, A2 e A3 
#-----------------------------------------------------------------------
...
if (leitura == 0):
   ...
   print ("## [61]: Gerar KPOINTS (Plano 2D ou Malha 3D na ZB)         ##")  
   if (SO == 2):
      print ("## [62]: (Em Edição !!!) Projecao 2D da Textura de Spin 3D  ##")   
   print ("##############################################################")   
