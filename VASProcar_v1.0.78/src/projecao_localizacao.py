...
print ("Para uma mesma Regiao utilize quantos intervalos precisar     ")
print ("==============================================================")
print ("Ao todo, quantos intervalos de ions vc ira fornecer abaixo? ==")
print ("##############################################################")
...
print ("--------------------------------------------------------------")
print ("ion_inicial ion_final Regiao: 1  5  A                         ")
print ("ion_inicial ion_final Regiao: 15 27 B                         ")          
print ("ion_inicial ion_final Regiao: 3  9  B                         ")
print ("ion_inicial ion_final Regiao: 0  0  E                         ")
print ("##############################################################") 
print (" ")  
...
for i in range (1,(loop+1)):
    print (f'{i} intervalo: =================================================')
    print (" ")
    loop_i, loop_f, loop_cha = input ("ion_inicial ion_final Regiao: ").split()
    loop_i = int(loop_i)
    loop_f = int(loop_f)
    #-----------------------------------
