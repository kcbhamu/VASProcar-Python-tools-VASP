...
#-----------------------------------------------------------------------------
if os.path.isdir("output/Spin_Texture/figures"):
   0 == 0
else:
   os.mkdir("output/Spin_Texture/figures")
#-----------------------------------------   
...
print ("Dica: Escolha entre 1 e 4 ====================================")
print ("##############################################################")
...
#-------------------------------------------------------
spin = open("output/Spin_Texture/Spin_Texture.dat", "w")
#-------------------------------------------------------
...
try: f = open('output/Spin_Texture/Spin_Texture_Video.py'); f.close(); os.remove('output/Spin_Texture/Spin_Texture_Video.py')
except: 0 == 0
   
source = main_dir + '/plot/plot_spin_texture_contour_video.py'
destination = 'output/Spin_Texture/Spin_Texture_Video.py'
...
file = open('output/Spin_Texture/Spin_Texture_Video.py', 'r')
...
linha += 1; lines.insert(linha, f'tipo_contour = {tipo_contour}  #  Forma de obtenção dos Valores das Curvas de Nivel, onde [0] é Automatico pelo código e [1] Informado pelo usuários \n')
...
file = open('output/Spin_Texture/Spin_Texture_Video.py', 'w')
file.writelines(lines)
file.close()

#-------------------------------------------------------------
exec(open('output/Spin_Texture/Spin_Texture_Video.py').read())
#-------------------------------------------------------------
