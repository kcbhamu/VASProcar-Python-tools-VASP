...
print ("##############################################################")
print ("Defina as diferentes Regioes da rede a serem destacadas.      ")
print ("==============================================================")
print ("Cada Regiao deve ser composta por meio de intervalos_de_ions. ")
print ("==============================================================")
...
print ("ion_inicial ion_final: 4 15                                   ")
print ("ion_inicial ion_final: 2 2                                    ")
print ("##############################################################")
print(" ")

print ("##############################################################")
print ("Quantos REGIOES da rede vc deseja analisar/destacar? =========")
print ("============ (Sao permitidos no maximo 5 REGIOES)  ===========")
print ("##############################################################")
...
for i in range(1,(n_reg+1)):
    print ("==============================================================")
    print (f'Digite o rotulo da REGIAO {i}: =================================')
    print ("==============================================================")
    rotulo = input ("rotulo: "); rotulo = str(rotulo)
    print(" ")

    if (i == 1): loop_cha = "A"; rotulo_A = rotulo
    if (i == 2): loop_cha = "B"; rotulo_B = rotulo
    if (i == 3): loop_cha = "C"; rotulo_C = rotulo
    if (i == 4): loop_cha = "D"; rotulo_D = rotulo
    if (i == 5): loop_cha = "E"; rotulo_E = rotulo 

    print ("==============================================================")
    print (f'Quantos intervalos_de_ions deseja fornecer a REGIAO {i}? =======')
    print ("==============================================================")
    ...
    for j in range (1,(loop+1)):
        #--------------------------------------------------------------------------
        print ("==============================================================")
        print (f'Informe o intervalo_{j} de ions da REGIAO {i} ({rotulo}) ')
        r_ions = input ("ion_inicial ion_final: ").split()
        print (" ")
        #----------------------
        loop_i = int(r_ions[0])
        loop_f = int(r_ions[1])
...
for wp in range(1, (n_procar+1)):    
    ...
    for point_k in range(1, (nk+1)):                                  
        ...
        for Band_n in range (1, (nb+1)):
            ...
            if (Soma_A != 0):
               contribuicao.write(f'Regiao 1 ({rotulo_A}): {Soma_A:7,.3f}% \n')
            if (Soma_B != 0):
               contribuicao.write(f'Regiao 2 ({rotulo_B}): {Soma_B:7,.3f}% \n')
            if (Soma_C != 0):
               contribuicao.write(f'Regiao 3 ({rotulo_C}): {Soma_C:7,.3f}% \n')
            if (Soma_D != 0):
               contribuicao.write(f'Regiao 4 ({rotulo_D}): {Soma_D:7,.3f}% \n')
            if (Soma_E != 0):
               contribuicao.write(f'Regiao 5 ({rotulo_E}): {Soma_E:7,.3f}% \n')
