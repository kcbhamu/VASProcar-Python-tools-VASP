...
#-----------------------------------------------------------------------------
if os.path.isdir("output/Spin_Texture"):
   0 == 0
else:
   os.mkdir("output/Spin_Texture")
#---------------------------------
...
if (escolha == -21):
   ...
   if (escolha_d == 1):
      ...
      print ("==============================================================")
      print ("Estes valores correspondem a quantas vezes, o comprimento sera") 
      print ("multiplicado (aumentado) ou dividido (diminuido).             ")
      print ("##############################################################")    
...
#----------------------------------------------------------
spin_3D = open("output/Spin_Texture/Spin_Texture.dat", "w")
#----------------------------------------------------------
...
try: f = open('output/Spin_Texture/Spin_Texture_' + name + '.py'); f.close(); os.remove('output/Spin_Texture/Spin_Texture_' + name + '.py')
except: 0 == 0
   
source = main_dir + '/plot/plot_spin_texture_' + name + '.py'
destination = 'output/Spin_Texture/Spin_Texture_' + name + '.py'
...
file = open('output/Spin_Texture/Spin_Texture_' + name + '.py', 'r')
...
file = open('output/Spin_Texture/Spin_Texture_' + name + '.py', 'w')
file.writelines(lines)
file.close()

#-------------------------------------------------------------------
if (escolha_d == 1):
   exec(open('output/Spin_Texture/Spin_Texture_2D.py').read())
   
if (escolha_d == 2):
   exec(open('output/Spin_Texture/Spin_Texture_3D.py').read())
   
if (escolha_d == 3):
   exec(open('output/Spin_Texture/Spin_Texture_4D.py').read())
   
if (escolha_d == 4):
   exec(open('output/Spin_Texture/Spin_Texture_4D_[iso].py').read())
#-------------------------------------------------------------------
