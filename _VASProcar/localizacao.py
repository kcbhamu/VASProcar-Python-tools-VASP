...
if (save_png == 1): plt.savefig('saida/Localizacao/Localizacao_estados.png', dpi = 300)
if (save_pdf == 1): plt.savefig('saida/Localizacao/Localizacao_estados.pdf', dpi = 300)
if (save_eps == 1): plt.savefig('saida/Localizacao/Localizacao_estados.eps', dpi = 300)
