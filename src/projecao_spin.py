...
#-----------------------------------------------------------------
if os.path.isdir("output/Spin"):
   0 == 0
else:
   os.mkdir("output/Spin")
#------------------------
...
#-----------------------------------------------------------------------
    ...
    if (t == 1):
       #------------------------------------------------
       projection = open("output/Spin/Spin_Sx.agr", "w")
       #------------------------------------------------
       print ("Analisando a Projecao Sx do Spin")
       letras = 'Sx'
    if (t == 2):
       #------------------------------------------------
       projection = open("output/Spin/Spin_Sy.agr", "w")
       #------------------------------------------------
       print ("Analisando a Projecao Sy do Spin")
       letras = 'Sy'
    if (t == 3):
       #------------------------------------------------
       projection = open("output/Spin/Spin_Sz.agr", "w")
       #------------------------------------------------
...
#-------------------------------------------
bandas = open("output/Spin/Bandas.dat", "w")
#-------------------------------------------
...
#---------------------------------------
spin = open("output/Spin/Spin.dat", "w")
#---------------------------------------
...
try: f = open('output/Spin/Spin.py'); f.close(); os.remove('output/Spin/Spin.py')
except: 0 == 0
   
source = main_dir + '/plot/plot_projecao_spin.py'
destination = 'output/Spin/Spin.py'
...
file = open('output/Spin/Spin.py', 'r')
...
file = open('output/Spin/Spin.py', 'w')
file.writelines(lines)
file.close()

#---------------------------------------
exec(open('output/Spin/Spin.py').read())
#---------------------------------------
