print (" ")
print ("###############################################################")
print ("## VASProcar v1.0.16 (05/02/2022)                            ##")
...
if (escolha == 1   or escolha == -1):   executavel = Diretorio + '/bandas.py'  
...
if (escolha == 7   or escolha == -7):   executavel = Diretorio + '/plot_4D_plotly.py'     
