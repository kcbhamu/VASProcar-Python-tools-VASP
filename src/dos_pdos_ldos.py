...
#-----------------------------------------------------------------------
    ...
    if (i == 1):
       #------------------------------------------------------------------
       if (esc == 0): dos_pdos = open("output/DOS/DOS_pDOS.agr", "w")
       if (esc == 1): dos_pdos = open("output/DOS/DOS_pDOS_lDOs.agr", "w")
       #------------------------------------------------------------------
       print ("=================================") 
    ...
    if (i == 2):
       #----------------------------------------------------------------
       if (esc == 0): dos_pdos = open("output/DOS/pDOS_P.agr", "w")
       if (esc == 1): dos_pdos = open("output/DOS/pDOS_lDOS_P.agr", "w") 
       #----------------------------------------------------------------
    ...
    if (i == 3):
       #----------------------------------------------------------------
       if (esc == 0): dos_pdos = open("output/DOS/pDOS_D.agr", "w")
       if (esc == 1): dos_pdos = open("output/DOS/pDOS_lDOS_D.agr", "w")
       #----------------------------------------------------------------
...
#--------------------------------------------------------
dos_pdos_ldos = open("output/DOS/DOS_pDOS_lDOS.dat", "w")
#--------------------------------------------------------
...
try: f = open('output/DOS/DOS_pDOS_lDOS.py'); f.close(); os.remove('output/DOS/DOS_pDOS_lDOS.py')
except: 0 == 0
   
source = main_dir + '/plot/plot_dos_pdos_ldos.py'
destination = 'output/DOS/DOS_pDOS_lDOS.py'
...
file = open('output/DOS/DOS_pDOS_lDOS.py', 'r')
...
file = open('output/DOS/DOS_pDOS_lDOS.py', 'w')
file.writelines(lines)
file.close()

#-----------------------------------------------
exec(open('output/DOS/DOS_pDOS_lDOS.py').read())
#-----------------------------------------------
