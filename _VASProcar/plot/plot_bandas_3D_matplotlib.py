...
if (save_png == 1): plt.savefig(Diretorio_saida + "Bandas_3d.png", dpi = 600, pad_inches = 0)
if (save_pdf == 1): plt.savefig(Diretorio_saida + "Bandas_3d.pdf", dpi = 600, pad_inches = 0)
if (save_eps == 1): plt.savefig(Diretorio_saida + "Bandas_3d.eps", dpi = 600, pad_inches = 0)
