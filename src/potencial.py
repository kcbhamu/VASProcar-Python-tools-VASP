...
#----------------------------------------------------------------------
if os.path.isdir("output/Potencial"):
   0 == 0
else:
   os.mkdir("output/Potencial")
#------------------------------
...
for l in range(1,(3+1)):
    ...
    #---------------------------------------------------------
    potencial = open('output/Potencial/' + name + '.agr', "w")
    #---------------------------------------------------------
    ...
    if (save_png == 1): plt.savefig('output/Potencial/' + name + '.png', dpi = 600)
    if (save_pdf == 1): plt.savefig('output/Potencial/' + name + '.pdf', dpi = 600)
    if (save_eps == 1): plt.savefig('output/Potencial/' + name + '.eps', dpi = 600)
