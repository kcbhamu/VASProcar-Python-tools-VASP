...
if os.path.isdir('saida'):
   Diretorio_saida = 'saida/Level_Countour/'
else:
   Diretorio_saida = ''
#----------------------
...
countour = np.loadtxt(Diretorio_saida + 'Level_Countour.dat') 
countour.shape
...
if (tipo_contour == 0):
   ...
   cp = plt.contour(x_grid, y_grid, z_grid, levels = n_contour, linestyles = '-', cmap = cmap_gray, alpha = 1.0, antialiased = True)

if (tipo_contour == 1):
   cp = plt.contourf(x_grid, y_grid, z_grid, levels, cmap = "bwr", alpha = transp, antialiased = True)
   cp = plt.contour(x_grid, y_grid, z_grid, levels, linestyles = '-', cmap = cmap_gray, alpha = 1.0, antialiased = True)
...
if (save_png == 1): plt.savefig(Diretorio_saida + "Level_Countour_2D.png", dpi = 600, pad_inches = 0)
if (save_pdf == 1): plt.savefig(Diretorio_saida + "Level_Countour_2D.pdf", dpi = 600, pad_inches = 0)
if (save_eps == 1): plt.savefig(Diretorio_saida + "Level_Countour_2D.eps", dpi = 600, pad_inches = 0)
...
if (tipo_contour == 1): plt.contour(x_grid, y_grid, z_grid, levels, linestyles = '-', cmap = cmap_black, alpha = 1.0, antialiased = True)
...
if (save_png == 1): plt.savefig(Diretorio_saida + "Level_Countour_3D.png", dpi = 600, pad_inches = 0)
if (save_pdf == 1): plt.savefig(Diretorio_saida + "Level_Countour_3D.pdf", dpi = 600, pad_inches = 0)
if (save_eps == 1): plt.savefig(Diretorio_saida + "Level_Countour_3D.eps", dpi = 600, pad_inches = 0)
...
if (Diretorio_saida != ''):
   ...
   print("= gerado na pasta saida\Level_Countour ==================")   
   print("=========================================================")
