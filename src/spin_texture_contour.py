...
try: f = open('output/Spin_Texture/Spin_Texture_Contour.py'); f.close(); os.remove('output/Spin_Texture/Spin_Texture_Contour.py')
except: 0 == 0
   
source = main_dir + '/plot/plot_spin_texture_contour.py'
destination = 'output/Spin_Texture/Spin_Texture_Contour.py'
...
file = open('output/Spin_Texture/Spin_Texture_Contour.py', 'r')
...
file = open('output/Spin_Texture/Spin_Texture_Contour.py', 'w')
file.writelines(lines)
file.close()

#---------------------------------------------------------------
exec(open('output/Spin_Texture/Spin_Texture_Contour.py').read())
#---------------------------------------------------------------
