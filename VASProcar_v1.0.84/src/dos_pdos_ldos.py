...
# Escrita do arquivo ".agr" do GRACE ===================================
    ...
    dos_pdos_ldos.write(f'@    legend loctype world \n')
    dos_pdos_ldos.write(f'@    legend {x_inicial}, {y_final} \n')
    dos_pdos_ldos.write(f'@    legend box fill pattern 4 \n')
    dos_pdos_ldos.write(f'@    legend length 1 \n')
