...
for i in range(n_energ):
    ...
    if (save_png == 1): plt.savefig(dir_output + 'Fermi_Surface_[' + c_energ + '].png', dpi = 600, pad_inches = 0)
    if (save_pdf == 1): plt.savefig(dir_output + 'Fermi_Surface_[' + c_energ + '].pdf', dpi = 600, pad_inches = 0)
    if (save_eps == 1): plt.savefig(dir_output + 'Fermi_Surface_[' + c_energ + '].eps', dpi = 600, pad_inches = 0)
