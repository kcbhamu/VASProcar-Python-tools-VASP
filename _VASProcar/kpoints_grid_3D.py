...
print("#### Observacao: Digite um numero impar para o GRID ###")
...
# inicial e final a fim de gerar os pontos restantes da malha 3D.
#------------------------------------------------------------------------
...
#------------------------------------------------------------------------
# Escrita dos dados das Bandas 3D: --------------------------------------
#------------------------------------------------------------------------
...
kpoints.write("Bandas_3D VASProcar \n")
