...
####################################################################################################################################
## Preencha os dados abaixo para executar este código isoladamente: ============================================================= ##
####################################################################################################################################
escolha   = 6    # [6] Plot Banda 3D  ou  Plot Banda 2D em 3D                                                                     ##
Band_i    = ???  # Banda inicial a ser plotada.                                                                                   ##                          
Band_f    = ???  # Banda final a ser plotada.                                                                                     ##
Plano_k   = 1    # [1] Plano (kx,ky) ou (k1,k2) // [2] Plano (kx,kz) ou (k1,k3) // [3] Plano (ky,kz) ou (k2,k3)                   ##
Dimensao  = 1    # [1] (kx,ky,kz) 2pi/Param. // [2] (kx,ky,kz) 1/Angs. // [3] (kx,ky,kz) 1/nm. // [4] (k1,k2,k3) Coord. Diretas   ##                               
tipo_plot = 0    # [0] Plotado em pontos // [1] Plotado superficies // [2] pontos + superficies                                   ##
####################################################################################################################################
...
try: f = open('Plot_Bandas_3D.py'); f.close(); Plot_3D = 1
except: Plot_3D = 0   

if (Plot_3D == 0 ):
   source = r'_VASProcar\saida_plot_bandas_3D.py'
   destination = r'Plot_Bandas_3D.py'
