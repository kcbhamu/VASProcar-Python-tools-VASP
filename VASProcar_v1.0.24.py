print (" ")
print ("###############################################################")
print ("## VASProcar v1.0.24 (09/02/2022)                            ##")
...
print ("## ======================================================== ##")
print ("## Plot da DOS, p-DOS e l-DOS:                              ##")
print ("## [11]: Configuracao Padrao   --   [-11]: Personalizado    ##")
print ("## ======================================================== ##")
print ("## Plot do Potencial Eletrostatico médio em (X, Y, Z):      ##")
print ("## [12]: Configuracao Padrao   --   [-12]: Personalizado    ##")
print ("##############################################################")
print ("## Plot da Densidade de Carga Parcial média em (X, Y, Z):   ##")
...
print ("##############################################################")
print ("## Plot - Banda 3D  ou  Plot Banda 2D em 3D: (ki, kj, E)    ##")
print ("## [6] Padrão  --  [-6] Personalizado                       ##")
print ("## ======================================================== ##")
print ("## [61] Gerar arquivo KPOINTS (Plano 2D ou Malha 3D na ZB)  ##")
print ("## ======================================================== ##")
if (SO == 2):
   print ("## Plot - Projecao 2D da Textura de Spin 3D                 ##")
   print ("##           !!!!! EM TESTES - Não Funcional !!!!!          ##")
   print ("## [62] Padrão  --  [-62] Personalizado                     ##")    
print ("##############################################################")
print ("## Plot 4D (ISOSUPERFICIES): (kx, ky, kz, E ou dE)          ##")
print ("## [7] Padrão  --  [-7] Personalizado                       ##")
print ("##############################################################")
...
if (escolha == 999 or escolha == -999): executavel = Diretorio + '/correction_procar.py'
