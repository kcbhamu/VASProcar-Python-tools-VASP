...
if (escolha == -62):
   ...
   print ("##############################################################")
   print ("## Deseja adotar um comprimento fixo para os vetores? ===== ##")
   print ("##############################################################")
   print ("## [1] SIM ================================================ ##")
   print ("## [0] NAO ================================================ ##")   
   print ("##############################################################") 
   normalizacao = input (" "); normalizacao = int(normalizacao)
   print (" ")
...
print(" ")
print("============ Plotando a Textura de Spin (Matplotlib): ============")
print(" ")
print(".........................")
...
plt.colorbar(sm, ticks = tk, shrink = 0.5, format='%.2f', label = rotulo2)

# plt.scatter(eixo1, eixo2, color = 'gray', s = 1, alpha = 0.5)

# width = espessura do vetor // scale = comprimento do vetor
if (Plano_k == 1):  ax.quiver(eixo1, eixo2, Spin_Sx, Spin_Sy, Spin_Sz, width = espessura, scale = comprimento, scale_units = 'inches', pivot = 'middle', cmap = icmap, norm = norm)
if (Plano_k == 2):  ax.quiver(eixo1, eixo2, Spin_Sx, Spin_Sz, Spin_Sy, width = espessura, scale = comprimento, scale_units = 'inches', pivot = 'middle', cmap = icmap, norm = norm)
if (Plano_k == 3):  ax.quiver(eixo1, eixo2, Spin_Sy, Spin_Sz, Spin_Sx, width = espessura, scale = comprimento, scale_units = 'inches', pivot = 'middle', cmap = icmap, norm = norm)
 
fig = plt.gcf()
fig.set_size_inches(8,6)

if (save_png == 1): plt.savefig('saida/Spin_Texture/Spin_Texture_' + rotulo1 + '.png', dpi = 600, pad_inches = 0)
if (save_pdf == 1): plt.savefig('saida/Spin_Texture/Spin_Texture_' + rotulo1 + '.pdf', dpi = 600, pad_inches = 0)
if (save_eps == 1): plt.savefig('saida/Spin_Texture/Spin_Texture_' + rotulo1 + '.eps', dpi = 600, pad_inches = 0)
...
print("= [espessura] e [comprimento] no arquivo spin_texture.py ======")   
print("===============================================================") 
