...
print ("==============================================================")
print ("Use apenas 1 rotulo por regiao.                               ")
print ("##############################################################")
print(" ")

print ("##############################################################")
print ("Quantos intervalos de ions vc necessita ao todo? =============")
print ("##############################################################")
...
print ("--------------------------------------------------------------")
print ("ion_inicial ion_final Regiao Rotulo: 1  5  A Borda            ")
print ("ion_inicial ion_final Regiao Rotulo: 15 27 B Bulk             ")          
print ("ion_inicial ion_final Regiao Rotulo: 3  9  B Superficie       ")
print ("ion_inicial ion_final Regiao Rotulo: 0  0  E O+Zn             ")
print ("##############################################################") 
print (" ")  
